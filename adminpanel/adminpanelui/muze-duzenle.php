...
if (isset($_GET['muzeid'])) {
	...
	$muze = $muzesorgu->fetch(PDO::FETCH_ASSOC);
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<form class="col-sm-9" action="../formhandling/islem.php" method="POST">
				<h4 class="text-center text-primary">Müze Güncelleme İşlemleri</h4><hr>
				<div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_baslik" value="<?php echo $muze['muze_baslik'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_resim" value="<?php echo $muze['muze_resim'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<textarea  class="ckeditor" id="editor1" name="muze_aciklama"><?php echo $muze['muze_aciklama'] ?></textarea>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_acilis" value="<?php echo $muze['muze_acilis'] ?>" class="form-control" placeholder="Örn : 11:00">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_kapanis" value="<?php echo $muze['muze_kapanis'] ?>" class="form-control" placeholder="Örn : 11:00">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_ucret" value="<?php echo $muze['muze_ucret'] ?>" class="form-control" placeholder="60TL gibi...">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_telefon" value="<?php echo $muze['muze_telefon'] ?>" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_adres" value="<?php echo $muze['muze_adres'] ?>" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_il" value="<?php echo $muze['muze_il'] ?>" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_ilce" value="<?php echo $muze['muze_ilce'] ?>" class="form-control" placeholder="">
						</div>
					</div>

					<div class="form-group">
						<label class="control-label" for="first-name">Müze Konum --Buraya Google Mapsten kopyalanan link gelecek-- --Kopyalamadan Önce Kaynak Seçeneiğini İşaretle--width="100% olacak"<span class="required">*</span></label>
						<textarea  class="ckeditor" id="editor2" name="muze_konum"><?php echo "<p>".$muze['muze_konum']."</p>" ?></textarea>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="muze_tatil_gunu" value="<?php echo $muze['muze_tatil_gunu'] ?>" class="form-control" placeholder="Pazartesi,Salı">
						</div>
					</div>


					<div class="row">
						<input type="submit" name="muze_guncelle" value="Güncellemeyi Tamamla" class="btn btn-sm btn-block btn-danger">
					</div>

					<input type="hidden" name="muze_id_no" value="<?php echo $muze_id_no ?>">
					...
					<h4 class="text-primary text-center"><?php 
						...
						if (isset($_GET['guncellemedurumu'])) {
							
							if ($_GET['guncellemedurumu'] == 'yes') {
								echo "Müze Başarı ile Güncellendi";
							}

							else {
								echo "Müze Güncelleme Başarısız";
							}
