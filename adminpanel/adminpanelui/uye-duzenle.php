...
if (isset($_GET['uyeid'])) {
	...
	$uye_id_no = $_GET['uyeid'];
	
	$uyesorgu=$db->prepare("SELECT * FROM uyeler where uye_id=:id");
			...
			<form class="col-sm-9" action="../formhandling/islem.php" method="POST">
				...
				<div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="uye_nickname" value="<?php echo $uye['uye_nickname'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="uye_password" value="<?php echo $uye['uye_password'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="uye_adsoyad" value="<?php echo $uye['uye_adsoyad'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label" for="first-name">Üye Mail <span class="required">*</span>
						</label>
						<div class="">
							<input type="text" id="first-name" required="required" name="uye_mail" value="<?php echo $uye['uye_mail'] ?>" class="form-control">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="">
							<input type="text" id="first-name" required="required" name="uye_gsm" value="<?php echo $uye['uye_gsm'] ?>" class="form-control" placeholder="">
						</div>
					</div>
					...
					<div class="row">
						<input type="submit" name="uye_guncelle" value="Güncellemeyi Tamamla" class="btn btn-sm btn-block btn-danger">
					</div>

					<input type="hidden" name="uye_id_no" value="<?php echo $uye_id_no ?>">
					...
					if (isset($_GET['guncellemedurumu'])) {
						...
						if ($_GET['guncellemedurumu'] == 'yes') {
							echo "Üye Başarı ile Güncellendi";
						}

						else {
							echo "Üye Güncelleme Başarısız";
						}
